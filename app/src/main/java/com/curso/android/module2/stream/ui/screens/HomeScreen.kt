...
private fun SongCard(
    ...
    Column(
        ...
        IconButton(
            ...
            val icon = if (song.isFavorite) Icons.Filled.Favorite else Icons.Outlined.FavoriteBorder
            val tint = if (song.isFavorite) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurfaceVariant
            Icon(
                imageVector = icon,
